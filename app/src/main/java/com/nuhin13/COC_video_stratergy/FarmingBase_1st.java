 ...
 */
public class FarmingBase_1st extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Farming Base");
        //getSupportActionBar().setLogo(R.drawable.mainlogo);
       /* getSupportActionBar().setTypeface(Typeface.createFromAsset(context.getAssets(),
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()){
                    ...
                    case R.id.inbox:
                        Intent intent1 = new Intent( FarmingBase_1st.this, Strategical_video_1st.class);
                        startActivity(intent1);
                       // Toast.makeText(getApplicationContext(), "Stared Selected", Toast.LENGTH_SHORT).show();
                        FarmingBase_1st.this.finish();
                        return true;

                    // For rest of the options we just show a toast on click

                    case R.id.starred:
                        Intent intent3 = new Intent(FarmingBase_1st.this, WarBase_1st.class);
                    ...
                    case R.id.like:
                        ...
                        String facebookUrl = fb.getFacebookPageURL(FarmingBase_1st.this);
    ...
    private void initAd() {
        ...
        mInterstitialAd = new InterstitialAd(FarmingBase_1st.this);
    ...
    public void th7(View v) {
        Intent intent = new Intent(FarmingBase_1st.this, Th7_farming_base.class);
        startActivity(intent);

    }
    public void th8(View v) {

        Intent intent = new Intent(FarmingBase_1st.this, Th8_farming_base.class);
        startActivity(intent);

    }
    public void th_9(View v) {

        Intent intent = new Intent(FarmingBase_1st.this, Th9_farming_base.class);
        startActivity(intent);
    ...
    public void th10(View v) {
        ...
        Intent intent = new Intent(FarmingBase_1st.this, Th10_farming_base.class);
        startActivity(intent);

    }
    public void th11(View v) {

        Intent intent = new Intent(FarmingBase_1st.this, Th11_farming_base.class);
        startActivity(intent);
